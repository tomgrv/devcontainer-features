...
echo "$(tput setaf 4)Configuring git for this repo...$(tput sgr0)"
...
echo "$(tput setaf 4)Configuring aliases for this repo...$(tput sgr0)"
...
echo "$(tput setaf 4)Configuring scripts for this repo...$(tput sgr0)"
