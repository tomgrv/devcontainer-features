...
if [ -f "./composer.json" ]; then
    ...
    jq '.devDependencies| .[]' ${source:-.}/config/_composer.require.json | xargs -I {} composer require --dev $opts {}

    jq '.globalDependencies| .[]' ${source:-.}/config/_composer.require.json | xargs -I {} composer global require $opts {}
